...
/**
 * TwoFieldCalculatorUI Component
 *
 * Renders the UI for a two-field calculator, displaying sections and their lines.
 * Supports inline editing of section titles, line descriptions, and two measurements.
 *
 * @param {Object} props
 ...
 */
export default function TwoFieldCalculatorUI({
  calculator,
  editingState,
  isRefreshing,
  safeAction,
